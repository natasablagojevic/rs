...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCityThreadENDCLASS_t qt_meta_stringdata_CLASSCityThreadENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 7),  // "artikal"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 11),  // "predjeniPut"
        QT_MOC_LITERAL(32, 3)   // "put"
    },
    "CityThread",
    "artikal",
    "",
...
void CityThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->artikal((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CityThread::artikal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &CityThread::predjeniPut; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CityThread::artikal(QString _t1)
{
...
// SIGNAL 1
void CityThread::predjeniPut(uint _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
