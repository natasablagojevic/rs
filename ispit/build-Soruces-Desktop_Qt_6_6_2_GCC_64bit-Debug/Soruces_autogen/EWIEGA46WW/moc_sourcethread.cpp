...
#include "../../../Soruces/sourcethread.h"
...
constexpr auto qt_meta_stringdata_CLASSSourceThreadENDCLASS = QtMocHelpers::stringData(
    "SourceThread",
    "sourceLostFluid",
    ""
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSourceThreadENDCLASS_t qt_meta_stringdata_CLASSSourceThreadENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 15),  // "sourceLostFluid"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "SourceThread",
    "sourceLostFluid",
...
void SourceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sourceLostFluid((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SourceThread::sourceLostFluid; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SourceThread::sourceLostFluid(uint _t1)
{
